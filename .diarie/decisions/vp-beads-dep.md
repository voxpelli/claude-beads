...
for an agent or a gate, the question is _"what evidence of the intended outcome?"_, and here there is
almost none.
...
Corroborating artifact evidence (2026-07-15): the _used_ skills leave heavy traces —
...
construct _forcing_ a Claude-plugin packaging. With it gone, the only plugin-forcing constructs left
...
Retirement is a doc-and-reference sweep, not a delete (global rule: doc-grep _before_ the removal
