...
Nothing here needs to *ride* PR #8 — the point is to **not fight it** and to sequence the dissolution
...
Two cheap, conflict-free things you *may* do inside #8:
...
1. **Add a top-level `renames` map** (Claude Code v2.1.193+; it is **1:1 and intra-marketplace** — the
   successor must be listed in *this* marketplace):
